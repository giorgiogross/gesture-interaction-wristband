...
Until now, many research groups (\todo{Zitation}) have already worked on technologies which enable the user to control computers with gestures.
...
Overall, we established to recognize \todo{4} different gestures with an expectancy accuracy of \todo{95}\%.
